...
public class FFMStructAccessTest {
    ...
    public record Vec4iSegmentVoid(MemorySegment segment) {
        int x() { return segment.get(ValueLayout.JAVA_INT_UNALIGNED, 0L); }
        int y() { return segment.get(ValueLayout.JAVA_INT_UNALIGNED, 4L); }
        int z() { return segment.get(ValueLayout.JAVA_INT_UNALIGNED, 8L); }
        int w() { return segment.get(ValueLayout.JAVA_INT_UNALIGNED, 12L); }

        void x(int value) { segment.set(ValueLayout.JAVA_INT_UNALIGNED, 0L, value); }
        void y(int value) { segment.set(ValueLayout.JAVA_INT_UNALIGNED, 4L, value); }
        void z(int value) { segment.set(ValueLayout.JAVA_INT_UNALIGNED, 8L, value); }
        void w(int value) { segment.set(ValueLayout.JAVA_INT_UNALIGNED, 12L, value); }
    }
    ...
    private Vec4iSegmentVoid ssvd = new Vec4iSegmentVoid(src);
    private Vec4iSegmentVoid dsvd = new Vec4iSegmentVoid(dst);
    ...
    @Benchmark
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void copySegmentVoidAccessors() {
        var d = this.dsvd;
        var s = this.ssvd;
