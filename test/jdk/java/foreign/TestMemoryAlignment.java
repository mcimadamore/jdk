...
public class TestMemoryAlignment {
    ...
    public void testAlignedAccess(long align) {
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment segment = MemorySegment.allocateNative(aligned, arena);;
            vh.set(segment, -42);
    ...
    public void testUnalignedAccess(long align) {
        ...
        VarHandle vh = aligned.varHandle();
        try (Arena arena = Arena.openConfined()) {
            MemorySegment segment = MemorySegment.allocateNative(alignedGroup, arena);;
    ...
    public void testPackedAccess() {
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment segment = MemorySegment.allocateNative(g, arena);;
