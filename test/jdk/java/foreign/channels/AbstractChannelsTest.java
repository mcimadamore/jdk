...
public class AbstractChannelsTest {
    ...
    static ByteBuffer segmentBufferOfSize(SegmentAllocator session, int size) {
    ...
    static ByteBuffer[] segmentBuffersOfSize(int len, SegmentAllocator session, int size) {
     ...
     */
    static ByteBuffer[] mixedBuffersOfSize(int len, SegmentAllocator session, int size) {
        ByteBuffer[] bufs;
