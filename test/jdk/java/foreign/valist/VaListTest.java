...
public class VaListTest extends NativeTestHelper {
    ...
    private static final Function<Consumer<VaList.Builder>, VaList> winVaListFactory
            = actions -> Windowsx64Linker.newVaList(actions, SegmentAllocator.auto());
    private static final Function<Consumer<VaList.Builder>, VaList> sysvVaListFactory
            = actions -> SysVx64Linker.newVaList(actions, SegmentAllocator.auto());
    private static final Function<Consumer<VaList.Builder>, VaList> linuxAArch64VaListFactory
            = actions -> LinuxAArch64Linker.newVaList(actions, SegmentAllocator.auto());
    private static final Function<Consumer<VaList.Builder>, VaList> macAArch64VaListFactory
            = actions -> MacOsAArch64Linker.newVaList(actions, SegmentAllocator.auto());
    private static final Function<Consumer<VaList.Builder>, VaList> platformVaListFactory
            = (builder) -> VaList.make(builder, SegmentAllocator.auto());

    private static final BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> winVaListScopedFactory
            = Windowsx64Linker::newVaList;
    private static final BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> sysvVaListScopedFactory
            = SysVx64Linker::newVaList;
    private static final BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> linuxAArch64VaListScopedFactory
            = LinuxAArch64Linker::newVaList;
    private static final BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> macAArch64VaListScopedFactory
            = MacOsAArch64Linker::newVaList;
    private static final BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> platformVaListScopedFactory
            = VaList::make;
    ...
    public void testVaListMemorySegment(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment msInt = arena.allocate(JAVA_INT);;
    ...
    public static Object[][] structs() {
        TriFunction<GroupLayout, VarHandle, VarHandle, Function<VaList, Integer>> sumStructJavaFact
                ...
                list -> {
                    MemorySegment struct = SegmentAllocator.auto().allocate(pointLayout);
    ...
    public void testStruct(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment struct = arena.allocate(Point_LAYOUT);;
    ...
    public static Object[][] bigStructs() {
        TriFunction<GroupLayout, VarHandle, VarHandle, Function<VaList, Long>> sumStructJavaFact
                ...
                list -> {
                    MemorySegment struct = SegmentAllocator.auto().allocate(BigPoint_LAYOUT);
    ...
    public void testBigStruct(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment struct = arena.allocate(BigPoint_LAYOUT);;
    ...
    public static Object[][] floatStructs() {
        TriFunction<GroupLayout, VarHandle, VarHandle, Function<VaList, Float>> sumStructJavaFact
                ...
                list -> {
                    MemorySegment struct = SegmentAllocator.auto().allocate(FloatPoint_LAYOUT);
    ...
    public void testFloatStruct(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
        ...
        try (Arena arena = Arena.openConfined()) {
            MemorySegment struct = arena.allocate(FloatPoint_LAYOUT);;
    ...
    public static Object[][] hugeStructs() {
        QuadFunc<GroupLayout, VarHandle, VarHandle, VarHandle, Function<VaList, Long>> sumStructJavaFact
                ...
                list -> {
                    MemorySegment struct = SegmentAllocator.auto().allocate(HugePoint_LAYOUT);
    ...
    public void testHugeStruct(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
        ...
        // passed by reference.
        try (Arena arena = Arena.openConfined()) {
            MemorySegment struct = arena.allocate(HugePoint_LAYOUT);;
    ...
    public void testStack(Function<Consumer<VaList.Builder>, VaList> vaListFactory,
                          ...
                          ValueLayout.OfDouble doubleLayout) {
        try (Arena arena = Arena.openConfined()) {
            MemorySegment longSum = arena.allocate(longLayout);;
            MemorySegment doubleSum = arena.allocate(doubleLayout);;
    ...
    public void testScopedVaList(BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> vaListFactory,
                                 BiFunction<Integer, VaList, Integer> sumInts,
                                 ValueLayout.OfInt intLayout) {
        VaList listLeaked;
        try (Arena arena = Arena.openConfined()) {
    ...
    public void testCopy(BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> vaListFactory, ValueLayout.OfInt intLayout) {
    ...
    public void testCopyUnusableAfterOriginalClosed(BiFunction<Consumer<VaList.Builder>, SegmentAllocator, VaList> vaListFactory,
                                                    ValueLayout.OfInt intLayout) {
        VaList copy;
        try (var arena = Arena.openConfined()) {
            VaList list = vaListFactory.apply(b -> b.addVarg(intLayout, 4)
    ...
    public static Object[][] upcalls() {
        ...
        return new Object[][]{
                ...
                { linkVaListCB("upcallStruct"), VaListConsumer.mh(vaList -> {
                    MemorySegment struct = SegmentAllocator.auto().allocate(Point_LAYOUT);
                ...
                { linkVaListCB("upcallStack"), VaListConsumer.mh(vaList -> {
                    ...
                    MemorySegment buffer = SegmentAllocator.auto().allocate(BigPoint_LAYOUT);
    ...
    static VaList segmentToValist(MemorySegment segment) {
        return VaList.ofAddress(segment.address(), SegmentAllocator.auto());
    }
    ...
    private static void buildVaList(VaList.Builder builder, List<MemoryLayout> contents) {
        for (MemoryLayout layout : contents) {
            if (layout instanceof ValueLayout.OfInt ofInt) {
                ...
                builder.addVarg(ofAddress, SegmentAllocator.global().wrap(1, null));
            }
        }
    }
    ...
    private static void nextVarg(VaList vaList, MemoryLayout layout) {
        if (layout instanceof ValueLayout.OfInt ofInt) {
            ...
            assertEquals(vaList.nextVarg(ofAddress), SegmentAllocator.global().wrap(1, null));
        }
    }
