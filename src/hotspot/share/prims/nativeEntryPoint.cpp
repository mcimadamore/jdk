...
JNI_ENTRY(jlong, NEP_makeDowncallStub(JNIEnv* env, jclass _unused, jobject method_type, jobject jabi,
  ...
  return (jlong) DowncallLinker::make_downcall_stub(
    basic_type, pslots, ret_bt, abi, input_regs, output_regs, needs_return_buffer, trivial)->code_begin();
JNI_END
...
static JNINativeMethod NEP_methods[] = {
  {CC "makeDowncallStub", CC "(" METHOD_TYPE ABI_DESC VM_STORAGE_ARR VM_STORAGE_ARR "ZZ)J", FN_PTR(NEP_makeDowncallStub)},
