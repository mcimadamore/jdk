...
public abstract class Buffer {
    ...
    //
    Buffer(long address, Object base, int mark, int pos, int lim, int cap,
           boolean readOnly, ByteOrder order, Object attachment, MemorySegmentProxy segment) {       // package-private
        if (cap < 0)
        ...
        SharedSecrets.setJavaNioAccess(
            new JavaNioAccess() {
                ...
                public ByteBuffer newHeapByteBuffer(byte[] hb, int offset, int capacity, MemorySegmentProxy segment) {
                    return new ByteBuffer(Unsafe.ARRAY_BYTE_BASE_OFFSET + offset, hb, -1, 0, capacity, capacity, false, ByteOrder.BIG_ENDIAN, null, segment);
                }
