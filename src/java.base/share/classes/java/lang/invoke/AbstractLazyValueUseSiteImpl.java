...
final class AbstractLazyValueUseSiteImpl {
    private AbstractLazyValueUseSiteImpl() { }

    static <T> AbstractLazyValueUseSite<T> ofPlain() {
        return OfPlain.make();
    }

    static <T> AbstractLazyValueUseSite<T> ofCas() {
        return OfCas.make();
    }

    static <T> AbstractLazyValueUseSite<T> ofOnce() {
        return OfOnce.make();
    }

    @TrustFinalFields
    static final class OfPlain<T> extends AbstractLazyValueUseSite<T> {
        private T value;

        static <T> AbstractLazyValueUseSite<T> make() {
            return new OfPlain<>();
        }
    ...
    @TrustFinalFields
    static final class OfCas<T> extends AbstractLazyValueUseSite<T> {
    ...
    @TrustFinalFields
    static final class OfOnce<T> extends AbstractLazyValueUseSite<T> {
        private static final Unsafe UNSAFE = Unsafe.getUnsafe();
