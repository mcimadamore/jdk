 ...
 */
public interface LazyValueDeclSite<A, T> {
    /**
     * Lazy-update policy.
     */
    enum Policy {
        ...
        PLAIN() {
            @Override
            <A, T> LazyValueDeclSite<A, T> make(Function<? super A, ? extends T> computer) {
                return LazyValueDeclSiteImpl.ofPlain(computer);
            }
        ...
        CAS() {
            @Override
            <A, T> LazyValueDeclSite<A, T> make(Function<? super A, ? extends T> computer) {
                return LazyValueDeclSiteImpl.ofCas(computer);
            }
        ...
        ONCE() {
            @Override
            <A, T> LazyValueDeclSite<A, T> make(Function<? super A, ? extends T> computer) {
                return LazyValueDeclSiteImpl.ofOnce(computer);
            }

        };

        abstract <A, T> LazyValueDeclSite<A, T> make(Function<? super A, ? extends T> computer);
     ...
     * @return the lazy value
     */
    static <A, T> LazyValueDeclSite<A, T> of(Policy policy,
