...
final class LazyValueDeclSiteImpl {
    private LazyValueDeclSiteImpl() { }

    static <A, T> LazyValueDeclSite<A, T> ofPlain(Function<? super A, ? extends T> computer) {
        return OfPlain.of(computer);
    }

    static <A, T> LazyValueDeclSite<A, T> ofCas(Function<? super A, ? extends T> computer) {
        return OfCas.of(computer);
    }

    static <A, T> LazyValueDeclSite<A, T> ofOnce(Function<? super A, ? extends T> computer) {
        return OfOnce.of(computer);
    }

    @TrustFinalFields
    static final class OfPlain<A, T> implements LazyValueDeclSite<A, T> {
        ...
        static <A, T> LazyValueDeclSite<A, T> of(Function<? super A, ? extends T> computer) {
    ...
    @TrustFinalFields
    static final class OfCas<A, T> implements LazyValueDeclSite<A, T> {
    ...
    @TrustFinalFields
    static final class OfOnce<A, T> implements LazyValueDeclSite<A, T> {
        private static final Unsafe UNSAFE = Unsafe.getUnsafe();
