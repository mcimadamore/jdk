 ...
 * <p>
 * The simplest native allocator is the {@linkplain NativeAllocator#global() global allocator}. The global allocator
 ...
 * <p>
 * Finally, clients can use an {@linkplain Arena arena}. An arena features a <em>bounded lifetime</em> which
 * starts with the arena, and ends when the arena is {@linkplain Arena#close() closed}. As a result,
...
public sealed interface NativeAllocator extends SegmentAllocator permits Arena, MemorySessionImpl {
