 ...
 * (regardless of the allocator used to obtain the variable arity list).
 *
 * @since 19
 */
...
public sealed interface VaList permits WinVaList, SysVVaList, LinuxAArch64VaList, MacOsAArch64VaList, SharedUtils.EmptyVaList {
     ...
     * @throws IllegalStateException if the segment associated with this variable argument list is not
     * {@linkplain MemorySegment#isAlive() alive}.
     * @throws WrongThreadException if this method is called from a thread {@code T},
     * such that {@code segment().isAccessibleBy(T) == false}.
     ...
     * is always alive. Moreover, the size of the returned segment is {@code 0}.
     *
     * @param layout the layout of the value to be read.
    ...
    /**
     * Copies this variable argument list at its current position into a new variable argument list. The new variable
     * argument list has the same lifetime as this variable argument list. The behavior of this method is equivalent to the C
    ...
    /**
     * Returns an empty variable argument list.
     * The resulting variable argument list does not contain any argument, and throws {@link UnsupportedOperationException}
     * on all operations, except for {@link VaList#segment()}, {@link VaList#copy()}. Moreover, the segment
     * associated with the returned variable argument list is always alive.
