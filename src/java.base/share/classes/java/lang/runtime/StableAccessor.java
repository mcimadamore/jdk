...
public abstract class StableAccessor {
    ...
    private static class StaticAccessor extends StableAccessor {
        ...
        @Override
        @ForceInline
        public Object getOrInit(Object receiver) throws Throwable {
            Object cached = UNSAFE.getReferenceStable(base, offset);
            return cached != null ? cached : slowGetOrInit(base, receiver);
        }
    }
    ...
    private static final class InstanceAccessor extends StableAccessor {
        ...
        @ForceInline
        public Object getOrInit(Object receiver) throws Throwable {
            Object actualBase = requireNonNull(receiver);
            Object cached = UNSAFE.getReferenceStable(actualBase, offset);
            return cached != null ? cached : slowGetOrInit(actualBase, receiver);
        }
    }
}
