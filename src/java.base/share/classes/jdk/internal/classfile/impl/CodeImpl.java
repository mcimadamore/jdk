...
public final class CodeImpl
    ...
    private final LazyConstant<List<ExceptionCatch>> exceptionHandlers$constant = LazyConstant.of(this::exceptionHandlers$compute);

    @Override
    public List<ExceptionCatch> exceptionHandlers() {
        return exceptionHandlers$constant.get();
    }
