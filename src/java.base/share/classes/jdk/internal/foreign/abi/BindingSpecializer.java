...
public class BindingSpecializer {
    ...
    private static final String SCOPE_DESC = methodType(Arena.class).descriptorString();
    ...
    private static final String OF_LONG_UNCHECKED_DESC = methodType(MemorySegment.class, long.class, long.class, Arena.class).descriptorString();
