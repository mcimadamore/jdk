...
public class BindingSpecializer {
    ...
    private static final String SESSION_DESC = methodType(SegmentAllocator.class).descriptorString();
    ...
    private static final String OF_LONG_UNCHECKED_DESC = methodType(MemorySegment.class, long.class, long.class, SegmentAllocator.class).descriptorString();
