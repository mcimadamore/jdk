...
public final class UnionLayoutImpl extends AbstractGroupLayout<UnionLayoutImpl> implements UnionLayout {
    ...
    private UnionLayoutImpl(List<MemoryLayout> elements, long byteSize, long byteAlignment, long minByteAlignment,
        ...
        super(Kind.UNION, elements, byteSize, byteAlignment, minByteAlignment, name, canonicalLinkerName);
    }

    @Override
    UnionLayoutImpl dup(long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
        return new UnionLayoutImpl(memberLayouts(), byteSize(), byteAlignment, minByteAlignment, name, canonicalLinkerName);
    }
