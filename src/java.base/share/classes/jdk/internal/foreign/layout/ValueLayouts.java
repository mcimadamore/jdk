...
public final class ValueLayouts {
    ...
    abstract static sealed class AbstractValueLayout<V extends AbstractValueLayout<V> & ValueLayout> extends AbstractLayout<V> {
        ...
        public final V withOrder(ByteOrder order) {
            ...
            return dup(order, byteAlignment(), name(), canonicalLinkerName());
        }
        ...
        @Override
        final V dup(long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return dup(order(), byteAlignment, name, canonicalLinkerName);
        }

        abstract V dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName);
    ...
    public static final class OfBooleanImpl extends AbstractValueLayout<OfBooleanImpl> implements ValueLayout.OfBoolean {
        ...
        private OfBooleanImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(boolean.class, order, Byte.BYTES, byteAlignment, name, canonicalLinkerName);
        }

        private OfBooleanImpl(ByteOrder order, long byteAlignment, Optional<String> name) {
            this(order, byteAlignment, name, Optional.empty());
        }

        @Override
        OfBooleanImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfBooleanImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfByteImpl extends AbstractValueLayout<OfByteImpl> implements ValueLayout.OfByte {
        ...
        private OfByteImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(byte.class, order, Byte.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfByteImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfByteImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfCharImpl extends AbstractValueLayout<OfCharImpl> implements ValueLayout.OfChar {
        ...
        private OfCharImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(char.class, order, Character.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfCharImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfCharImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfShortImpl extends AbstractValueLayout<OfShortImpl> implements ValueLayout.OfShort {
        ...
        private OfShortImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(short.class, order, Short.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfShortImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfShortImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfIntImpl extends AbstractValueLayout<OfIntImpl> implements ValueLayout.OfInt {
        ...
        private OfIntImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(int.class, order, Integer.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfIntImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfIntImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfFloatImpl extends AbstractValueLayout<OfFloatImpl> implements ValueLayout.OfFloat {
        ...
        private OfFloatImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(float.class, order, Float.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfFloatImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfFloatImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfLongImpl extends AbstractValueLayout<OfLongImpl> implements ValueLayout.OfLong {
        ...
        private OfLongImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(long.class, order, Long.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfLongImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfLongImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfDoubleImpl extends AbstractValueLayout<OfDoubleImpl> implements ValueLayout.OfDouble {
        ...
        private OfDoubleImpl(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            super(double.class, order, Double.BYTES, byteAlignment, name, canonicalLinkerName);
        }
        ...
        @Override
        OfDoubleImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfDoubleImpl(order, byteAlignment, name, canonicalLinkerName);
        }
    ...
    public static final class OfAddressImpl extends AbstractValueLayout<OfAddressImpl> implements AddressLayout {
        ...
        private OfAddressImpl(ByteOrder order, long byteSize, long byteAlignment, MemoryLayout targetLayout, Optional<String> name,
                              Optional<String> canonicalLinkerName) {
            super(MemorySegment.class, order, byteSize, byteAlignment, name, canonicalLinkerName);
            this.targetLayout = targetLayout;
        }

        private OfAddressImpl(ByteOrder order, long byteSize, long byteAlignment, MemoryLayout targetLayout, Optional<String> name) {
            this(order, byteSize, byteAlignment, targetLayout, name, Optional.empty());
        }

        @Override
        OfAddressImpl dup(ByteOrder order, long byteAlignment, Optional<String> name, Optional<String> canonicalLinkerName) {
            return new OfAddressImpl(order, byteSize(), byteAlignment, targetLayout, name, canonicalLinkerName);
        }
        ...
        public AddressLayout withTargetLayout(MemoryLayout layout) {
            ...
            return new OfAddressImpl(order(), byteSize(), byteAlignment(), layout, name(), canonicalLinkerName());
        }

        @Override
        public AddressLayout withoutTargetLayout() {
            return new OfAddressImpl(order(), byteSize(), byteAlignment(), null, name(), canonicalLinkerName());
        }
        ...
        public static AddressLayout of(ByteOrder order) {
            return new OfAddressImpl(order, ADDRESS_SIZE_BYTES, ADDRESS_SIZE_BYTES, null, Optional.empty(), Optional.empty());
        }
