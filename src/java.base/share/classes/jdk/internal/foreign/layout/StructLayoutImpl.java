...
public final class StructLayoutImpl extends AbstractGroupLayout<StructLayoutImpl> implements StructLayout {
    ...
    private StructLayoutImpl(List<MemoryLayout> elements, long byteSize, long byteAlignment, long minByteAlignment, Optional<String> name,
        ...
        super(Kind.STRUCT, elements, byteSize, byteAlignment, minByteAlignment, name, linkerOptions);
    }

    @Override
    StructLayoutImpl dup(long byteAlignment, Optional<String> name, List<Linker.Option> linkerOptions) {
        return new StructLayoutImpl(memberLayouts(), byteSize(), byteAlignment, minByteAlignment, name, linkerOptions);
    }
    ...
    public static StructLayout of(List<MemoryLayout> elements) {
        ...
        return new StructLayoutImpl(elements, size, align, align, Optional.empty(), List.of());
    }
